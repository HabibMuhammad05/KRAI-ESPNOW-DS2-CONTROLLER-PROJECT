...
uint8_t button[15] = {33, 18, 23, 19, 4, 15, 13, 12, 25, 26, 27, 14, 16, 17, 2}; // "L3", "R3", "L2", "L1", "UP", "LEFT", "DOWN", "RIGHT", "SQUARE", "CROSS", "ROUND", "TRIANGLE", "R2", "R1"
//32 voltagePin
uint8_t joy1XPin = 39; 
uint8_t joy1YPin = 36; 
uint8_t joy2XPin = 35; 
...
const int centerThreshold = 36;


uint8_t voltPin = 32; // voltage measurement pin
