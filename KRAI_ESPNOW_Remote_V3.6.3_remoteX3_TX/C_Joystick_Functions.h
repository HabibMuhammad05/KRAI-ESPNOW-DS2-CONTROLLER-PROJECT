...
void joystickRead(){
  ...
  sendData.joyData[0] = map(sendData.joyData[0], -1832, 2263, -4095, 4095);
  sendData.joyData[1] = map(sendData.joyData[1], -1825, 2270, -4095, 4095);
  sendData.joyData[2] = map(sendData.joyData[2], -1774, 2321, -4095, 4095);
  sendData.joyData[3] = map(sendData.joyData[3], -1813, 2282, -4095, 4095);
