...
//uint8_t broadcastAddress[] = {0x14, 0x33, 0x5C, 0x02, 0x49, 0x58}; // esp32 ext antenna 3
...
receivedData incomingData; //struct to store incoming data.
